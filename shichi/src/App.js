    ...
    <Router>
      <Routes>
        ...
        <Route
          path="/home"
          element={
            <ProtectedRoute element={<Home />} isLoggedIn={isLoggedIn} />
          }
        />
        <Route
          path="/history"
          element={
            <ProtectedRoute element={<History />} isLoggedIn={isLoggedIn} />
          }
        />
        <Route
          path="/car/:id"
          element={
            <ProtectedRoute element={<CarInfoPage />} isLoggedIn={isLoggedIn} />
          }
        />
        <Route
          path="/profile/:id"
        ...
        <Route
          path="/wallet"
          element={
            <ProtectedRoute element={<Wallet />} isLoggedIn={isLoggedIn} />
          }
        />
      </Routes>
    </Router>
