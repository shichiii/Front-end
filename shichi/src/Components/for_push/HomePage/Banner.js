...
const Hero = () => {
  ...
  return (
    <div>
      <div
        id="carcategory"
        class="bg-gradient-to-t from-pallate-Gunmetal via-pallate-Police_Blue to-pallate-Gunmetal min-h-screen py-12 flex items-center justify-center"
      >
          ...
          <div class="bg-pallate-Dark_Sky_Blue bg-opacity-20 text-white rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div class="p-4">
              <button
                ...
                class="w-full bg-pallate-Dark_Sky_Blue text-white rounded-full px-4 py-2 hover:bg-blue-200 hover:animate-pulse hover:text-black focus:outline-none focus:shadow-outline-blue active:bg-blue-800"
              >
                Show Economy
              </button>
            </div>
          ...
          <div class="bg-pallate-Dark_Sky_Blue bg-opacity-20 text-white rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div class="p-4">
              <button
                ...
                class="w-full bg-pallate-Dark_Sky_Blue text-white rounded-full px-4 py-2 hover:bg-green-200 hover:animate-pulse hover:text-black focus:outline-none focus:shadow-outline-green active:bg-green-800"
              >
                Show Compact
              </button>
            </div>
          ...
          <div class="bg-pallate-Dark_Sky_Blue bg-opacity-20 text-white rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
            ...
            <div class="p-4">
              <button
                ...
                class="w-full bg-pallate-Dark_Sky_Blue text-white rounded-full px-4 py-2  hover:bg-purple-200 hover:animate-pulse hover:text-black focus:outline-none focus:shadow-outline-purple active:bg-purple-800"
              >
                Show Luxury
              </button>
            </div>
...
://www.w3.org/2000/svg"
      ...
      {/* <div className="flex items-start bg-pallate-Gunmetal">
