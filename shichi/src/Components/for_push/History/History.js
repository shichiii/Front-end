  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (info.length > 0) {
          const firstCarImagesArray = info[0].advertisement.car_images;
                ...
                <table className="min-w-full">
                  ...
                  <tbody>
                    {info.map((item, index) => (
                      ...
                      >
                        {item?.advertisement.car_image1 &&
                        item?.advertisement.car_image1.length > 0 ? (
                          <td className="px-6 py-4">
                            <img
                              className="w-96 h-32 object-cover "
                              src={`http://87.107.54.89:8000${item?.advertisement.car_image1}`}
                              alt="Car Image"
                            />
                          </td>
                        ) : (
