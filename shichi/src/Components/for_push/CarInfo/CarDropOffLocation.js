...
function CarDropOffLocation({ car }) {
  ...
  return (
    <div className="w-[400px] rounded-2xl p-5 bg-pallate-Dark_Sky_Blue bg-opacity-30 lg:bg-opacity-20 h-96 flex flex-col justify-around ">
      ...
      <div>{car?.location?.state}</div>
      {/* <div className="text-xs text-slate-400">{car?.location?.state}</div> */}
