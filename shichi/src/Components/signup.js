    ...
    <div class="relative px-4 py-10 bg-pallate-Police_Blue shadow-lg sm:rounded-3xl sm:p-20">
      ...
      <div class="max-w-md mx-auto">
        ...
        <div class="divide-y divide-gray-200">
          ...
          <div class="relative">
              <input autoComplete="off" id="firstname" name="firstname" type="text" class="rounded-md peer placeholder-transparent h-8 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="First Name" onChange={handleFirstname}/>
            ...
            <div class="relative">
              <input autoComplete="off" id="lastname" name="lastname" type="text" class="rounded-md peer placeholder-transparent h-8 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Last Name" onChange={handleLastname}/>
